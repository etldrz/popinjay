...
# issue: when using the exit feature of enter_owned by pressing enter twice
...
#    #         enter_owned gets called from enter_read vs the 'new'
...
start_bookkeeping() {
	...
	case $input in
		...
		edit_book.sh $input_string $gotten
